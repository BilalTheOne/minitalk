...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/11/02 14:50:56 by bel-barb          #+#    #+#              #
#    Updated: 2023/11/28 14:27:11 by bel-barb         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
bonus: $(OBJ) $(BONUSES_OBJS)
	ar -rcs $(NAME) $(OBJ) $(BONUSES_OBJS)
